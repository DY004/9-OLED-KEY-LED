...
unsigned char gImage_bulethouch[10] [36] = {
{0x08,0x42,0x08,0x41,0xFF,0xFE,0x08,0x80,0x00,0x21,0x08,0xA1,0x19,0x22,0x2F,0x24},
{0x49,0x28,0x89,0xF0,0x09,0x28,0x29,0x24,0x19,0x22,0x0C,0x21,0x00,0x21,0x00,0x00},/*"挨",0*/
{0x00,0x04,0x7C,0xFC,0x44,0x04,0x47,0xF8,0x44,0x88,0x7C,0x88,0x00,0x10,0x00,0x24},
{0x7F,0x49,0x49,0xD2,0x49,0x64,0x49,0x48,0x49,0x72,0x7F,0x41,0x00,0x7E,0x00,0x00},/*"踢",1*/
{0x20,0x01,0x20,0x02,0x20,0x04,0x20,0x18,0x20,0x60,0x3F,0x80,0x22,0x00,0x22,0x00},
{0x22,0x02,0x22,0x01,0x22,0x02,0x23,0xFC,0x20,0x00,0x20,0x00,0x20,0x00,0x00,0x00},/*"万",2*/
{0x08,0x02,0x34,0x92,0x24,0x92,0x24,0x94,0x25,0x24,0x25,0x28,0xA6,0x4A,0x65,0x91},
{0x24,0xFE,0x24,0x20,0x24,0x50,0x24,0x88,0x25,0x08,0x2C,0x04,0x30,0x04,0x00,0x00},/*"家",3*/
};
...
{ 	  
    ...
    {    
        ...
        }else if(lcddev.id==0X1963)
        {
            ...
            LCD_SSD_BackLightSet(10);//背光设置为最亮
        }	    
    }
...
//str :字符串	 
//size:字体大小
//mode:模式	0,填充模式;1,非填充模式
void Gui_StrCenter(u16 x, u16 y, u8 *str,u8 size,u8 mode)
{
	//英文字符
	u16 len=strlen((const char *)str);
	u16 x1=(lcddev.width-len*12)/2;
	
	//Show_Str_1(x+x1,y,str,size,mode);
	LCD_ShowString(x+x1,y,200,size,size,str,mode);	
